...
public class CandidatesManager extends Menu<String>{
    ...
    public void execute(int n) {
        switch (n) {
            case 1:
                candidateRepository.createNewCandidate(candidates, 0);
                break;
            case 2:
                candidateRepository.createNewCandidate(candidates, 1);
                break;
            case 3:
                candidateRepository.createNewCandidate(candidates, 2);
                break;
            case 4:
                candidateRepository.searchCandidate(candidates);
                break;
            case 5:
